...
y <- as.numeric(DATA$Fatiga_Total)
...
#save.image("~/Documents/GitHub/tesis_Figueroa/MRI/WM_lasso_paper.RData")
load("../DATA/PCA_sorted.RData") #load("../DATA/WM_lasso_paper.RData")
library(patchwork)
library(ggcharts)
...
library(readr)
Datos_paper <- read_delim("../DATA/Datos_paper.csv", 
